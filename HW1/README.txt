...
P.S.: If for some reason it is not possible to run the code 
    directly, please check 'Homework 1.html' by opening it in 
    your browser. It is the same 'Homework 1.ipynb' but as a 
    ...
    that would be generated if 'Homework 1.ipynb' were to be ran.